    ...
    return (
        <>        <Card className='h-[calc(100vh-1rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5'>
            ...
            <List className='gap-6'>
                <ListItem onClick={() => setRequestType("pendingApprovals")}>
                    <ListItemPrefix>
                        <img src={pendingApproval} className='h-5 w-5' alt="" />
                    </ListItemPrefix>
                    Pending Approvals
                </ListItem>

                <ListItem onClick={() => setRequestType("ActiveUsers")}>
                    <ListItemPrefix>
                        <img src={activeUser} alt="" />
                    </ListItemPrefix>
                    Active Users
                </ListItem>
                <ListItem onClick={() => setRequestType("blockedUsers")}>
                    <ListItemPrefix>
                        <img src={blockedUser} className='h-6 w-6' alt="" />
                    </ListItemPrefix>
                    Blocked Users
                </ListItem>
                ...
                <ListItem onClick={() => setRequestType("adminsList")}>
                    <ListItemPrefix>
                        <img src={activeUser} className='h-5 w-5' alt="" />
                    </ListItemPrefix>
                    Admins
                </ListItem>
